/* READ THE COMMENTS IN THE CODE BELOW. THEY LOOK LIKE THIS */

import styled from "styled-components";
import React from "react";
/* COMMENT: "This above code links to frameworks that we use" - Helen */
...
`;
/* COMMENT from Helen: This above code gives the Shoe component styling to it (CSS) */

const Shoe = ({ style: { colourStitching, colourFront, colourBack }, width }) => {
/* COMMENT from Helen: This above code iniates the Shoe component, and grabs details that have been passed in elsewhere - including what colours it should be */
	return (
		<Wrapper width={width}>
		...
		/* COMMENT from Helen: This above code is the actual Shoe - the lines that draw it onto the screen. And it has links/hooks to the colours that have been passed in  */
	);
};

export default Shoe;
/* COMMENT from Helen: This above code makes the Shoe component available to other files so that it can be displayed where needed */
